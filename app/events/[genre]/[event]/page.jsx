          ...
          {rules && (
            <>
              ...
              {(rules.teams || rules.participants) && (
                <>
                  <h2>
                    No. of {rules.isTeam ? "teams" : "participants"} per IIT :
                  </h2>
                  <p>{rules.isTeam ? rules.teams : rules.participants}</p>
                </>
              )}
              {rules.isTeam && (
                <>
              ...
              {rules.street && (
                <>
                  <h2>The following is a list of street styles allowed :</h2>
                  <ul>
              ...
              {rules.criteria && (
                <>
                  ...
                  {rules.isCriteriaTable ? (
                    <ul>
                      {rules.criteria.map((criteria, idx) => (
