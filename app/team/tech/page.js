...
import styles from "./tech.module.css"; // Import your module CSS file for styling
  ...
  return (
    <div className={styles.coreOperationsPage}>
      ...
      <h1 className={myFont.className}>
        <div className={styles.heading}>Tech Coordinators</div>
      </h1>
      ...
      <h2 className={myFont.className}>
        <div className={styles.heading}>Tech Heads</div>
      </h2>
...
export default CoreOperationsPage;
